...
window.Modernizr = function (f, H, E) {
	...
	var P = [],
		a = P.slice,
		b, c = function (k, n, p, r) {
			var t, u, A = H.createElement("div"),
				D = H.body,
			...
			return t = ["&#173;<style>", k, "</style>"].join(""), A.id = "modernizr", (D ? A : F).innerHTML += t, F.appendChild(A), D || (F.style.background = "", K.appendChild(F)), u = n(A, k), D ? A.parentNode.removeChild(A) : F.parentNode.removeChild(F), !!u
		},
		d = {}.hasOwnProperty,
		e;
	"undefined" === typeof d || "undefined" === typeof d.call ? e = function (k, n) {
	...
	(function (k, n) {
		...
		c(p, function (t, u) {
			...
			w.csstransforms3d = 9 === (D.csstransforms3d && D.csstransforms3d.offsetLeft) && 3 === D.csstransforms3d.offsetHeight
		}, r, n)
	})([, ["@media (", f.join("transform-3d),("), "modernizr){#csstransforms3d{left:9px;position:absolute;height:3px;}}"].join("")], [, "csstransforms3d"]);
	C.csstransforms3d = function () {
		var k = !!B("perspective");
		return k && "webkitPerspective" in K.style &&
			(k = w.csstransforms3d), k
	};
	for (var g in C) e(C, g) && (b = g.toLowerCase(), w[b] = C[g](), P.push((w[b] ? "" : "no-") + b));
	M.cssText = "";
	return C = null, w._version = "2.5.3", w._prefixes = f, w._domPrefixes = O, w._cssomPrefixes = I, w.testProp = function (k) {
		return J([k])
	}, w.testAllProps = B, w.testStyles = c, w.prefixed = function (k, n, p) {
...
(function (f, H, E) {
	...
	var M = function () {
		function I() {
			var e = J(),
				g = d(a);
			e !== a ? (c(a = e, g), f(H).trigger("hashchange")) :
		...
		f.browser.msie && !C && function () {
			var e, g;
			O.start = function () {
				e || (g = (g = f.fn.hashchange.src) && g + J(), e = f('<iframe tabindex="-1" title="empty"/>').hide().one("load", function () {
					g || c(J());
					I()
				}).attr("src", g || "javascript:0").insertAfter("body")[0].contentWindow, B.onpropertychange = function () {
					try {
						"title" ===
			...
			c = function (k, n) {
				...
				k !== n && (p.title = B.title, p.open(), r && p.write('<script>document.domain="' + r + '"\x3c/script>'), p.close(), e.location.hash = k)
			}
		}();
		return O
	}()
	...
	(function (f, H, E, J) {
		...
		function K(h, l, m) {
			...
			if (h)
				...
				for (q in h) h.hasOwnProperty(q) && l.call(m, h[q], q, h)
		}
		...
		function u(h, l, m) {
			...
			1 < v && !l.firstMultiple ?
				l.firstMultiple = A(m) : 1 === v && (l.firstMultiple = !1);
			z = l.firstInput;
			...
			N = l.prevDelta || {};
			var R = l.prevInput || {};
			if (1 === m.eventType || 4 === R.eventType) N = l.prevDelta = {
				x: R.deltaX || 0,
				y: R.deltaY || 0
			}, G = l.offsetDelta = {
				x: z.x,
			...
			v ? (z = v.pointers, z = L(q[0], q[1], ba) / L(z[0], z[1], ba)) : z = 1;
			m.scale = z;
			v ? (v = v.pointers, q = Q(q[1], q[0], ba) + Q(v[1], v[0], ba)) : q = 0;
			m.rotation = q;
			m.maxPointers = l.prevInput ? m.pointers.length > l.prevInput.maxPointers ? m.pointers.length : l.prevInput.maxPointers : m.pointers.length;
			G = l.lastInterval || m;
			q = m.timeStamp - G.timeStamp;
			8 != m.eventType && (25 < q || G.velocity === J) ? (z = m.deltaX - G.deltaX, G = m.deltaY - G.deltaY, N = z / q || 0, R = G / q || 0, q =
				N, v = R, N = Y(N) > Y(R) ? N : R, z = F(z, G), l.lastInterval = m) : (N = G.velocity, q = G.velocityX, v = G.velocityY, z = G.direction);
			m.velocity = N;
			m.velocityX = q;
			m.velocityY = v;
			m.direction = z;
		...
		function A(h) {
			for (var l = [], m = 0; m < h.pointers.length;) l[m] = {
		...
		function D(h) {
			...
			for (var m = 0, q = 0, v = 0; v < l;) m += h[v].clientX, q += h[v].clientY, v++;
			return {
				x: aa(m / l),
				y: aa(q / l)
			}
		...
		function Da(h, l) {
			...
			if (1 === l)
				for (m = 0; m < N.length;) q[N[m].identifier] = !0, m++;
			for (m = 0; m < v.length;) q[v[m].identifier] && z.push(v[m]), l & 12 && delete q[v[m].identifier], m++;
		...
		function ta(h) {
			return h & 16 ? "cancel" : h & 8 ? "end" : h & 4 ? "move" : h & 2 ? "start" : ""
		}

		function ua(h) {
			return 16 == h ? "down" : 8 == h ? "up" : 2 == h ? "left" : 4 == h ? "right" : ""
		}
		...
		function va(h, l) {
			var m = h.element;
			m.style && K(h.options.cssProps, function (q, v) {
		...
		I(S, r, {
			handler: function (h) {
				...
				l & 2 && 1 !== h.which && (l = 4);
				this.pressed && this.allow && (l & 4 && (this.pressed = !1), this.callback(this.manager, l, {
					pointers: [h],
					changedPointers: [h],
					pointerType: "mouse",
					srcEvent: h
		...
		f.MSPointerEvent && (ra = "MSPointerDown", sa = "MSPointerMove MSPointerUp MSPointerCancel");
		I(V, r, {
			handler: function (h) {
				var l = this.store,
					m = !1,
				...
				q & 1 && (0 === h.button ||
					z) ? 0 > G && (l.push(h), G = l.length - 1) : q & 12 && (m = !0);
				0 > G || (l[G] = h, this.callback(this.manager, q, {
					pointers: l,
					changedPointers: [h],
					pointerType: v,
					srcEvent: h
		...
		I(W, r, {
			handler: function (h) {
				var l = Na[h.type],
					m = Da.call(this, h, l);
				m && this.callback(this.manager, l, {
					pointers: m[0],
					changedPointers: m[1],
					pointerType: "touch",
					srcEvent: h
		...
		ia.prototype = {
			set: function (h) {
				...
				xa && this.manager.element.style && (this.manager.element.style[wa] = h);
		...
		U.prototype = {
			...
			requireFailure: function (h) {
				...
				h = ca(h, this); - 1 === e(l, h) && (l.push(h), h.requireFailure(this));
				return this
			},
			dropRequireFailure: function (h) {
				if (w(h, "dropRequireFailure", this)) return this;
				h = ca(h, this);
				h = e(this.requireFail, h); - 1 < h && this.requireFail.splice(h, 1);
				return this
			},
			...
			recognize: function (h) {
				h = C({}, h);
				P(this.options.enable, [this, h]) ? (this.state & 56 && (this.state = 1), this.state = this.process(h), this.state & 30 && this.tryEmit(h)) : (this.reset(), this.state = 32)
			},
			process: function (h) {},
		...
		I(T, U, {
			...
			process: function (h) {
				var l = this.state,
					...
					q = l & 6;
				h = this.attrTest(h);
				return q && (m & 8 || !h) ? l | 16 : q || h ? m & 4 ? l | 8 : l & 2 ? l | 4 : 2 : 32
			}
		});
		I(da, T, {
			defaults: {
			...
			directionTest: function (h) {
				var l = this.options,
					...
					z = h.deltaX,
					G = h.deltaY;
				v & l.direction || (l.direction & 6 ? (v = 0 === z ? 1 : 0 > z ? 2 : 4, m = z != this.pX, q = Math.abs(h.deltaX)) : (v = 0 ===
					G ? 1 : 0 > G ? 8 : 16, m = G != this.pY, q = Math.abs(h.deltaY)));
				h.direction = v;
				return m && q > l.threshold && v & l.direction
			},
			attrTest: function (h) {
				return T.prototype.attrTest.call(this, h) && (this.state & 2 || !(this.state & 2) && this.directionTest(h))
			},
			emit: function (h) {
				this.pX = h.deltaX;
				this.pY = h.deltaY;
		...
		I(ja, T, {
			...
			emit: function (h) {
				1 !== h.scale && (h.additionalEvent = this.options.event + (1 > h.scale ? "in" : "out"));
				this._super.emit.call(this, h)
			}
		});
		I(ka, U, {
			...
			process: function (h) {
				...
				else if (h.eventType & 1) this.reset(),
			...
			emit: function (h) {
				8 === this.state && (h && h.eventType & 4 ? this.manager.emit(this.options.event + "up", h) : (this._input.timeStamp = ha(), this.manager.emit(this.options.event, this._input)))
			}
		});
		I(la, T, {
			defaults: {
		...
		I(ma, T, {
			...
			attrTest: function (h) {
				...
				else l & 6 ? m = h.overallVelocityX : l & 24 && (m = h.overallVelocityY);
				return this._super.attrTest.call(this, h) && l & h.offsetDirection && h.distance > this.options.threshold && h.maxPointers == this.options.pointers && Y(m) > this.options.velocity &&
					h.eventType & 4
			},
			emit: function (h) {
		...
		I(ea, U, {
			...
			process: function (h) {
				...
				if (q && v && m) {
					if (4 !=
						h.eventType) return this.failTimeout();
					...
					this._input = h;
					if (0 === this.count % l.taps) return this.hasRequireFailures() ? (this._timer = B(function () {
						this.state = 8;
						this.tryEmit()
					}, l.interval, this), 2) : 8
				}
		...
		na.prototype = {
			set: function (h) {
				...
				h.inputTarget && (this.input.destroy(), this.input.target = h.inputTarget, this.input.init());
				return this
			},
			stop: function (h) {
			...
			recognize: function (h) {
				...
				if (!l.stopped) {
					...
					for (var v = 0; v < m.length;) {
						var z = m[v];
						2 === l.stopped || q && z != q && !z.canRecognizeWith(q) ? z.reset() :
							z.recognize(h);
		...
		"function" == typeof define && define.amd ? define(function () {
			return X
		}) : "undefined" != typeof module && module.exports ? module.exports = X : f[E] = X
...
(function (f) {
	function H(a, b) {
		...
		e = this.pagesContainer = this.origin = f("<div class='wowbook-origin'></div>").css({
			position: "absolute"
		}).appendTo(a);
		c.bookShadow = f("<div class='wowbook-book-shadow'></div>").appendTo(a).css({
			top: 0,
			position: "absolute",
			display: "none",
			zIndex: 0
		...
		c.shadowClipper = f(".wowbook-shadow-clipper", e).css({
			display: "none"
		});
		c.foldShadow = f("<div class='wowbook-shadow-fold'></div>").appendTo(c.shadowContainer);
		c.foldGradientContainer = f("<div class='wowbook-fold-gradient-container'></div>").appendTo(c.shadowContainer);
		c.foldGradientElem = f("<div class='wowbook-fold-gradient'></div>").appendTo(c.foldGradientContainer);
		c.hardPageDropShadow = f("<div class='wowbook-hard-page-dropshadow'></div>").css({
			display: "none"
		}).appendTo(e);
		!f.support.opacity && f.wowBook.support.filters && f.wowBook.applyAlphaImageLoader(["wowbook-fold-gradient", "wowbook-fold-gradient-flipped", "wowbook-shadow-fold", "wowbook-shadow-fold-flipped"]);
		c.shadowContainer.css("position", "relative");
		this.leftHandle = f("<div class='wowbook-handle wowbook-left'></div>").data("corner", "l").appendTo(e);
		this.rightHandle = f("<div class='wowbook-handle wowbook-right'></div>").data("corner", "r").appendTo(e);
		Modernizr.csstransforms3d && (d = f("<div>").css("transform", "perspective(1px)"), this.perspectiveUnit = "none" != d.css("transform") ? "px" : "", d = null);
		f.browser.msie && f(".wowbook-handle", a).css({
			backgroundColor: "#fff",
			opacity: "0.01"
		});
		f(".wowbook-handle", e).bind("mousedown.wowbook",
			function (r) {
				return c.pageEdgeDragStart(r)
			});
		b.curl && f(".wowbook-handle", e).hover(function (r) {
			c.curlTimer || (c.curlTimer = setTimeout(function () {
				var t = r.target == c.leftHandle[0] ? c.leftPage() : c.rightPage();
				if (t) {
					var u = t.offset();
					c.curl(t, r.pageY - u.top > c.pageHeight * c.currentScale * c._cssZoom / 2)
				}
			}, 120))
		}, function () {
		...
		var g, k;
		f(".wowbook-handle", e).on("mousedown.wowbook", function () {
			g = f.now();
			k = f(this).data("corner")
		}).on("mouseup.wowbook", function () {
			var r = f(this).data("corner");
			if (!((new Date).getTime() - g > c.opts.handleClickDuration || r != k)) {
		...
		this.clipBoundaries && (this.origin.wrap("<div class='wowbook-clipper'><div class='wowbook-inner-clipper'></div></div>"), f(".wowbook-inner-clipper", a).css({
			position: "absolute",
			width: "100%",
			overflow: "hidden"
		...
		f.browser.ie8mode && this.zoomContent.wrapInner("<div class='IE8-zoom-helper'style='position:relative'></div>");
		this.zoomWindow.css({
			position: "absolute",
			top: 0
		});
		...
		this.fillToc();
		e = b.useTranslate3d;
		Modernizr.csstransforms3d && e && (f.wowBook.useTranslate3d = 1 == e || "mobile" == e && f.wowBook.utils.isMobile());
		...
		if (b.deepLinking && this.getLocationHash()) {
			...
			"number" === typeof p && (c.startPage = p, b.moveToViewPort && !J(c.elem) && c.elem[0].scrollIntoView())
		}
		this.flipSound && (this.audio = this.createAudioPlayer());
		this.opts.keyboardNavigation && (p = f.wowBook.defaults.keyboardNavigation, this.rtl && this.opts.keyboardNavigation == p && (this.opts.keyboardNavigation = {
			back: p.advance,
			advance: p.back
		...
		f(window).on("hashchange.wowbook", function () {
			...
			if (r === c.locationHashSetTo) c.locationHashSetTo = void 0;
				...
				var t = (r = "" === r && !c.locationEndsInHash()) ? c.startPage : c.locationHashToPage();
				"number" === typeof t && (c.gotoPage(t, !r), r || !b.moveToViewPort || J(c.elem) || c.elem[0].scrollIntoView())
			}
		});
		b.forceBasicPage && (this.foldPage =
			this.holdHardpage = this.foldPageBasic);
		f.wowBook.support.transform || (this.foldPage = this.foldPageBasic, f.wowBook.support.filters || (this.holdHardpage = this.foldPageBasic));
		this.mouseWheel && ("zoom" == c.mouseWheel && a.bind("mousemove.wowbook mouseenter.wowbook", function (r) {
			c._mousemoveEvent = r
		...
		this.toolbars = [];
		this.opts.toolbar &&
			(this.createToolbar(this.opts.toolbar), this.opts.responsiveToolbar && (this.opts.lightbox || this.opts.container) && this.setupResponsiveToolbar());
	...
	function B(a, b, c) {
		...
		if (!f.wowBook.support.boxSizing) {
			var g;
			e = "none" == a.css("borderTopStyle") ? 0 : K[g = a.css("borderTopWidth")] || parseFloat(g);
			d = "none" == a.css("borderRightStyle") ?
				0 : K[g = a.css("borderRightWidth")] || parseFloat(g);
			var k = "none" == a.css("borderBottomStyle") ? 0 : K[g = a.css("borderBottomWidth")] || parseFloat(g);
			var n = "none" == a.css("borderLeftStyle") ? 0 : K[g = a.css("borderLeftWidth")] || parseFloat(g);
			d = parseFloat(a.css("paddingLeft")) + parseFloat(a.css("paddingRight")) + n + d;
	...
	f.fn.wowBook = function (a) {
		...
		return this.each(function () {
			if (f.wowBook(this)) console.log("Error: the following element cannot be used twice by wowBook plugin: ", this);
			else {
				var g = new H(this, e);
	...
	H.prototype = {
		...
		setDimensions: function (a, b) {
			...
			d && this.centeredWhenClosed && (g = parseFloat(e.css("left"), 10), e.css("left", g / (d / this.pageWidth)));
			this.bookShadow.css({
				width: a,
				height: b
			});
			...
			this.opts.handleWidth && f(".wowbook-handle", e).css("width", this.opts.handleWidth);
			this.rightHandle.css("left", a - this.rightHandle.width());
			if (this.clipBoundaries || this._restoreClipBoundaries) d = Math.ceil(Math.sqrt(this.pageWidth * this.pageWidth + this.pageHeight * this.pageHeight)), d = [this.pageHeight - d, c.width(), d, 0], this.origin.css("top",
				-d[0]), f(".wowbook-inner-clipper", c).css({
				width: "100%",
				height: d[2] - d[0],
				top: d[0]
			}), this.clipper.css({
		...
		setPagesDimension: function () {
			for (var a, b, c, d = 0, e = this.pages.length; d <
				e; d++) page = this.pages[d], b = page.isCover ? this.pageWidth : this.opts.pageWidth || this.pageWidth, c = page.isCover ? this.pageHeight : this.opts.pageHeight || this.pageHeight, page.pageWidth = b, page.pageHeight = c, page.css({
				width: b,
				height: c,
				left: page.onLeft ? 0 : this.pageWidth
			}), a = f(".wowbook-page-content", page), B(a, b, c), this.setPageCorners(page);
			this.opts.gutterShadow && f(".wowbook-gutter-shadow", this.elem).css("height", c)
		},
		...
		scaleToFit: function (a, b) {
			...
			this.opts.maxHeight &&
				b > this.opts.maxHeight && (b = this.opts.maxHeight);
		...
		responsiveResizeHandler: function () {
			if (f.wowBook.utils.isIOS) {
				var a = this.opts.container == window && this.container ||
					...
					b = f(window);
				if (a && (a.outerHeight() != b.height() || a.outerWidth() != b.width()) && (this.safariFixTotalDelayedTime || (this.safariFixTotalDelayedTime = 0), 800 > (this.safariFixTotalDelayedTime || 0))) {
					var c = this;
					setTimeout(function () {
		...
		insertPage: function (a, b) {
			if (this.isDoublePage(a)) this.insertDoublePage(a, b);
				...
				var c = f("<div class='wowbook-page'></div>").css({
					width: this.pageWidth,
					height: this.pageHeight,
					display: "none",
					position: "absolute"
				}).appendTo(this.pagesContainer).append(a);
				f.wowBook.support.boxSizing && a.css(f.wowBook.support.boxSizing, "border-box");
		...
		insertDoublePage: function (a, b) {
			if (!this._insertingDoublePage) {
				...
				e.css(f.wowBook.support.boxSizing + "", "border-box").wrap("<div class='wowbook-double-page'></div>");
				c.parent().data("src", c.data("src"));
				d.parent().data("src", d.data("src"));
				c.parent().data("image", c.data("image"));
				d.parent().data("image", d.data("image"));
				if (this.rtl) g = this.insertPage(d.parent(), !0), e = this.insertPage(c.parent(), !0);
				else {
				...
				e && (e.otherHalf = g);
				g && (g.otherHalf = e);
				f.wowBook.support.boxSizing || (B(c, 2 * this.pageWidth, this.pageHeight), B(d, 2 * this.pageWidth, this.pageHeight));
				b || this.updateBook();
		...
		loadPage: function (a) {
			...
			if (a && !a.loaded && !a.loading && (a.src || a.image || a.cached || this.pdfDoc)) {
				...
				var b = this;
				if (a.src) a.otherHalf && a.otherHalf.loading || f.get(a.src, function (d) {
		...
		selectPagesToUnload: function (a) {
			...
			for (var n = 0, p = this.pages.length; n < p; n++) {
				var r = this.pages[n];
				r.loaded && n != c && n != a && n != d && n != e && n != g && n != k && !this.isPageToKeep(r) &&
					b.push(n)
			}
			return b
		},
		...
		updateBook: function (a) {
			...
			for (var d = 0, e = this.pages.length - 1; d <= e; d++) {
				var g = this.pages[d].toggleClass("wowbook-left", b).toggleClass("wowbook-right", !b).data({
					pageIndex: d,
					holded: !1
				});
				g.pageIndex =
				...
				g.cover = !1;
				g.insideCover = !1;
				g.isCover = c && (0 == d || d == e || this.closable && 1 == d || d == e - 1 && !this.otherPage(e));
				var k = f(".wowbook-page-content", g);
				g.src = this.replaceNumberHolder(k.data("src") || this.opts.srcs, d);
				g.image = this.replaceNumberHolder(k.data("image") || this.opts.images, d);
				1 != g.loaded && (g.loaded = !g.src && !g.image && !g.cached);
				!g.loaded && this.opts.loadingIndicator && g.addClass("wowbook-loading");
				g.onLeft = b;
				g.onRight = !b;
				b = !b;
				g.thickness = this.opts.pageThickness;
				c && (g.thickness = g.isCover ? this.opts.pageThickness :
					"1px")
			}
			this.setCovers();
			this.setPagesDimension();
		...
		setCovers: function () {
			function a(k) {
				if (0 == k || k == b) {
					...
					if (n) {
						var p = c.backPage(k);
						c.otherPage(k) ? p || (n.cover = !1, n.insideCover = !0) : (n.cover = !0, n.insideCover = !1, p && !p.cover && (p.insideCover = !0))
					}
				}
			}
			...
			for (var d =
					0, e = this.pages.length - 1; d <= e; d++) {
				var g = c.pages[d];
				g.insideCover && (g.onLeft ? c.insideCoverLeft = g : c.insideCoverRight = g, c.differentPageSizes && (g.keep = !0))
			}
		},
		...
		doPageNumbering: function () {
			...
			if (a.pageNumbers && this.pages.length) {
				...
				for (c = 0; c < d; c++) f(".wowbook-page-number", this.pages[c]).remove();
				for (c = b + 1; c < a; c++) f(".wowbook-page-number", this.pages[c]).remove();
				for (c = d; c <= b; c++) this.pages[c].number =
		...
		upsertNumberInPage: function (a) {
			...
			if (a.number || 0 === a.number) {
				...
				b.length || (content = f(".wowbook-page-content", a), b = f('<div class="wowbook-page-number"></div>').appendTo(content));
				b.html(a.number)
			}
		},
		...
		findPagesType: function () {
			...
			for (a = this.pages.length; a--;) d = e || b[a] || this.pages[a].hardPageSetByUser,
		...
		showPage: function (a, b) {
			...
			this.differentPageSizes && (null !== e && this.loadPage(this.insideCoverLeft), null !== g && this.loadPage(this.insideCoverRight));
			...
			this.differentPageSizes && (null !== e && this.insideCoverLeft.css("display", "block"), null !== g && this.insideCoverRight.css("display", "block"));
			e = 0 == a || !this.closable && 1 == a;
			n = a == n || a == this.otherPage(n);
			this.leftHandle.toggleClass("wowbook-disabled",
				!this.backPage(c));
			...
			(c = this.onShowPage) && f.isFunction(c) && !this.isOnPage(a) && (this.currentPage = a, c(this, this.pages[a],
				a), (d = this.otherPage(a)) && c(this, this.pages[d], d));
			this.currentPage = a;
			this.pdf && this.pdfUpdateRender();
			this._controls.currentpage && this.updateCurrentPageControl();
			this._sliding || (c = this._singlePage && this.pageIsOnTheRight(a) ? -k : 0, this.origin.css("left", c), this.origin.css("transform", ""));
			this.centeredWhenClosed && !this._singlePage && (c = !!this.leftPage(a), d = this.rightPage(a), this.origin.css("left", c && d ? 0 : c ? k / 2 : -k / 2));
			this.positionBookShadow();
			!1 !== b && this.opts.updateBrowserURL && this.locationHashToPage() !=
				a && (this.locationHashSetTo = window.location.hash = this.pageToLocationHash(a));
			this.showThumbnail()
		},
		slideX: function (a, b) {
		...
		holdPage: function (a, b, c, d, e) {
			...
			if (a) {
				...
				if (e) {
					...
					if (!this._singlePage && this.centeredWhenClosed && (0 === g || 0 === p || n && (p === k || g === k))) {
						var r = 0,
							t = !this.rtl,
							u = this.pageWidth;
						if (t ? 0 ===
						...
						if (t ? g === k && n : 0 === g) A = u, D = 3 * u / 2, F = u / 2, L = 0, Q = u, S = 2 * u, V = b, Z = S;
						if (t ? 0 === p : p === k && n) A = u / 2, D = g === (t ? k : 0) ? u : 3 * u / 2, F = g === (t ? k : 0) ? u / 2 : 0, L = -u / 2, Q = A, S = 2 * u, V = b, Z = S;
						if (t ? p === k && n : 0 === p) A = g === (t ? 0 : k) ? 0 : -u / 2, D = u / 2, F = u / 2, L = g === (t ? 0 : k) ? -u / 2 : 0, Q = -u, S = D, V = Q, Z = b;
						if (b < A) {
							r = F;
							var W = V
						}
						b > D && (r = L, W = Z);
						b >= A && b <= D && (b = (b - A) / (D - A), r = F + b * (L - F), W = Q + b * (S - Q));
						b = W;
						this.origin.css("left", r);
						this.positionBookShadow()
					}
					this.zoomed || "basic" == this.pageType(a) ||
						"basic" == this.pageType(e) ? this.foldPageBasic(a, b, c, d, e) : a.isHardPage || e.isHardPage ? this.holdHardpage(a, b, c, d, e) : this.foldPage(a, b, c, d, e);
		...
		foldPageStart: function (a, b, c, d, e) {
			...
			if (e && e.length) {
				...
				this.foldGradientElem.css("height",
					g.foldGradientHeight);
		...
		foldPageStyles: function (a) {
			...
			if ("l" == r || "r" == r) {
				...
				r = (n >= t.y ? "t" : "b") + (this.pageIsOnTheLeft(a.pageIndex) ? "l" :
					"r");
				a.corner = r;
			...
			L = E(D, n);
			F = L.x + k + d + .5;
			a.pageContent.css("transform", g(-F, 0) + " rotate(" + (-u).toFixed(7) + "deg)");
			a.page.css("transform", g((Math.cos(n) * F).toFixed(5), (Math.sin(n) * F).toFixed(5)) + " rotate(" + u.toFixed(7) + "deg)");
			L = this.calculateOpacity(k, b, this.shadowThreshold, 50);
			if (this.shadows && 0 < L) {
				var Q = a.shadowTop;
				this.internalShadow.css({
					transform: g(F + (a.page.onRight ? a.page.pageWidth : 0), Q) + " rotate(" + u + "deg)",
					transformOrigin: d - F + "px " + (e + (a.shadowHeight - c) / 2) + "px"
				});
				F -= a.foldShadowWidth;
				this.foldShadow.css({
					transform: g(F + (a.page.onRight ? a.page.pageWidth : 0), Q) + " rotate(" + u + "deg)",
			...
			a.back.css("transform", g((r + p + Math.cos(n) * F).toFixed(5),
				(t - c + Math.sin(n) * F).toFixed(5)) + " rotate(" + u + "deg)");
			L = this.calculateOpacity(2 * k, 2 * b, this.foldGradientThreshold, 50);
			this.foldGradient && 0 < L ? (this.foldGradientContainer.css({
				opacity: L,
				display: "block",
				transform: g(b - r - a.foldGradientWidth / 2, t - a.foldGradientHeight / 2) + " rotate(" + -u + "deg)"
			}), this.foldGradientElem.css("transform", g(-k + a.foldGradientWidth / 2, 0)), a.foldGradientVisible || (this.foldGradientContainer.css("display", "block"), a.foldGradientVisible = !0)) : a.foldGradientVisible && (this.foldGradientContainer.css("display",
		...
		flipHardPageStart: function (a, b, c, d, e) {
			...
			!this.border3D && this.opts.pageThickness &&
				this.opts.use3d && Modernizr.csstransforms3d && (this.border3D = f('<div class="wowbook-3d-border">'), this.border3D.css("background", this.opts.pageEdgeColor));
			this.opts.hardPageShadow && !this.hardPageShadow && (this.hardPageShadow = f('<div class="wowbook-hard-page-shadow">'));
			var g = {};
			"number" === typeof a && (a = this.pages[a]);
			g.book = this;
			g.page = a;
			...
			if (e && e.length) {
				...
				a.css("zIndex", 1E5);
				e.css("zIndex", 1E5);
				this.opts.use3d && Modernizr.csstransforms3d && (a.css(Modernizr.prefixed("perspectiveOrigin"), "0 50%"), e.css(Modernizr.prefixed("perspectiveOrigin"), "0 50%"));
				b = a.onLeft ? k : 0;
		...
		flipHardPageStyles: function (a) {
			...
			if (this.opts.use3d && Modernizr.csstransforms3d) {
				var t = g ? -this._calculateAngleFromX(-a, k) : this._calculateAngleFromX(a, k);
				if (this.animating) {
					var u =
						this._animationData;
					if (this.curledPage || u.curled) u.curled = !0, u.angle || (r = {
						from: t,
						to: 0
					}, u.angle = r, t = a + u.dx, r.to = g ? -this._calculateAngleFromX(-t, k) : this._calculateAngleFromX(t, k), Math.abs(a) == k && (r.from = 0), Math.abs(t) == k && (r.to = 0), r.delta = r.to - r.from), t = u.angle.from - u.angle.delta * (u.from.x - d) / u.dx
				}
				e.append(this.border3D);
				this.hardPageShadow && (e.append(this.hardPageShadow), this.hardPageShadow.css("opacity", 1 - p));
				e.css({
			...
			!f.wowBook.support.transform && f.wowBook.support.filters && (e.css("filter", "progid:DXImageTransform.Microsoft.Matrix(M11=" + (p + ", M12=0, M21=" + Math.tan(r) * p + ", M22=1, sizingMethod='auto expand')")), e.css({
				marginTop: n - e.height(),
				marginLeft: g ? k - e.width() : 0
			}));
			this.shadows && this.hardPageDropShadow.css({
				left: g ? b.onLeft ? b.left : c.left : k,
				opacity: Math.abs(a) < k / 2 ? 0 : (Math.abs(a) - k / 2) / k * .8
			})
		},
		...
		foldPageBasicStyles: function (a) {
			...
			if (g) {
				...
				k = b.left + (k - d)
			} else p = "rect(-1000px " + (d - n) + "px " + e + "px -1000px)", e = "rect(-1000px " + n + "px " + e + "px -1000px)", k = c.left + (d - k + d);
			b.css("clip", p);
			c.css({
				clip: e,
				left: k,
			...
			p = this.calculateOpacity(2 * n, 2 * d, this.shadowThreshold,
				50);
			this.shadows && 0 < p ? (b = g ? b.left + n - a.foldShadowWidth : c.left + d - n + d, this.shadowContainer.css("opacity", p), this.foldShadow.css({
				left: b,
				display: "block"
			})) : this.foldShadow.css("display", "none");
			p = this.calculateOpacity(2 * n, 2 * d, this.foldGradientThreshold, 50);
			this.foldGradient && 0 < p ? (b = g ? d - n : n - a.foldGradientWidth, this.foldGradientContainer.css({
				opacity: p,
				left: b,
				display: "block"
		...
		flip: function (a, b, c, d) {
			...
			if (!e.animating) {
				...
				var k = d.corner || c.data("holdedCorner"),
					n = f.easing[d.easing] || d.easing || function (p) {
		...
		releasePage: function (a, b, c,
			...
			if (b && g) this.flip({
				...
				complete: function () {
					...
					foldPageBasic: null,
					holded: !1
				}), this.clipBoundaries && !this.zoomed && (this.clipper.css("overflow",
					...
					transform: "",
					left: ""
				}), this.foldGradientElem.removeClass("wowbook-fold-gradient-flipped").css("transform", ""), this.foldGradientContainer.css("transform",
		...
		gotoPage: function (a, b) {
			...
			if (!this.animating) {
				...
				if (k) {
					...
					if (this.closable && this.differentPageSizes && k.isCover != p.isCover && k.pageIndex !== a) {
						if (0 == k.pageIndex || 0 == p.pageIndex) this.showPage(1, !1);
						else {
							var r = this.pages.length - 1;
							this.otherPage(r) || k.pageIndex != r && p.pageIndex != r || this.showPage(this.backPage(r).pageIndex, !1)
						}
						...
						var t =
							p && p.is(":visible");
						if (d)
							for (d = k.pageIndex - 1; 0 <= d; d--) this.pages[d].css("display", "none");
						else
							for (d = k.pageIndex + 1, c = this.pages.length; d < c; d++) this.pages[d].css("display", "none");
						n && (n.css("display", "block"), n.onLeft ? this.insideCoverLeft.css("display", "block") : this.insideCoverRight.css("display", "block"));
						...
						e ? (t = t || {
							x: 0,
							y: 0
						}, e = 2 * g.pageWidth, c = "bl" != d ? 0 : k.pageHeight) : (t = t || {
							x: k.pageWidth,
							y: 0
						}, e = -k.pageWidth, c = "br" != d ? 0 : k.pageHeight);
						var A = "linear";
						if (this.centeredWhenClosed && !this._singlePage && (k.isHardPage || p.isHardPage)) {
							r = this.pages.length - 1;
							var D = !this.rtl;
							A = "easeOutCubic";
							this.pageIsOnTheRight(this.currentPage) && !this.otherPage(this.currentPage) && (e += this.pageWidth / 2, a != (D ? r : 0) || this.otherPage(a) || (e += this.pageWidth / 2));
							this.pageIsOnTheLeft(this.currentPage) && !this.otherPage(this.currentPage) && (e -= this.pageWidth / 2, a != (D ? 0 : r) || this.otherPage(a) || (e -= this.pageWidth / 2))
						}
						if (this._singlePage) {
		...
		pageBelow: function (a) {
			a = parseInt(a, 10);
			if (a != a) return null;
			a += this.pageIsOnTheLeft(a) != this.rtl ? -2 :
				2;
			if (0 > a || a > this.pages.length - 1) a = null;
			return a
		},
		...
		advanceAfterTimeout: function (a) {
			...
			this.slideShowTimer = setTimeout(function () {
				if (b.animating || b.holdedPage) b.advanceAfterTimeout(100);
					...
					b.opts.slideShowLoop || !c ? b.advanceAfterTimeout(b.slideShowDelay + b.turnPageDuration) : b.stopSlideShow()
				}
			}, a)
		},
		...
		fillToc: function (a, b) {
			...
			if (0 !== c.length) {
				...
				for (var g = 0, k = e.length; g < k; g++) {
					var n = e[g];
					n = b.replace(/\$\{link\}/g, "#" + this.id + "/" + n.id.substr(1)).replace(/\$\{section\}/g,
						n.title).replace(/\$\{page\}/g, n.page);
		...
		createToc: function (a) {
			a = this.opts.toc || a || [];
			var b = this.tocContainer = f("<div class='wowbook-toc' style='display:none'>").prependTo(f(this.opts.tocParent || "body"));
		...
		selectorToPage: function (a) {
			a =
				f(a, this.elem).closest(".wowbook-page");
		...
		zoomSetup: function () {
			...
			this.toggleControl("zoomOut", this.zoomLevel ==
				this.zoomMin);
		...
		_zoomUpdateOnRAF: function () {
			if (this._zoomDataRAF) {
				...
				a.transform = !0;
				this._zoom(c, a);
				b && 1 > Math.abs(d) && 1 > Math.abs(e) && 1 > Math.abs(this.zoomLevel - c) && (this._zoomDataRAF.callback && this._zoomDataRAF.callback.call(this), this._zoomDataRAF = null)
			}
		},
		_zoom: function (a, b) {
			b || (b = {});
			...
			p = n.left - t.left;
			t = n.top - t.top;
			p && (p += parseFloat(g.css("marginLeft")), g.css("marginLeft", p), k.marginLeft = p);
			t && (t += parseFloat(g.css("marginTop")), g.css("marginTop", t), k.marginTop = t);
			g = "";
			t = this._zoomOffset.dx / d;
			p = this._zoomOffset.dy / d;
			f.wowBook.support.transform &&
				(t || p) ? g = f.wowBook.utils.translate(t, p) : k.css({
					left: t,
					top: p
				});
			c ? (e /= d, g += this.opts.useScale3d ? "scale3d(" + e + "," + e + ",1)" : "scale(" + e + ")") : (this._cssZoom = e, k.css("zoom", e), k.css("marginLeft", -k.marginLeft / d), k.css("marginTop", -k.marginTop / d));
			f.wowBook.support.transform && k.css("transform", g);
			1 !== this.zoomLevel ? this.zoomed || (k.css("marginLeft", -k.marginLeft / d), k.css("marginTop", -k.marginTop / d), c && k.css("transformOrigin", "0 0"), this.elem.find("img").each(function () {
				var u = f(this);
				u.data("wowbook-draggable-before-zoom",
					u.attr("draggable"));
				u.attr("draggable", !1)
			})) : this.zoomFinished();
			this.zoomed = 1 !== a;
		...
		zoom: function (a, b, c) {
			...
			c || (c = {});
			if (a <= this.zoomMin && !c.resetting) return this.zoomReset(b,
				c);
			...
			if (a !== this.zoomLevel || c.force)
				if (void 0 == b && (b = this.opts.zoomDuration), 0 == b) {
					...
					this._zoomAnimating && (f(this).stop(), d && this.zoomContent.css("transform", ""));
					this._zoomAnimating = this.zoomLevel;
					var g = this;
					e = c.x;
					var k = c.y;
					void 0 == e && (e = this.pageWidth * (this._singlePage ? 1 : 2) * this.currentScale *
						this.opts.zoomFocusX);
					void 0 == k && (k = this.pageHeight * this.currentScale * this.opts.zoomFocusY);
					var n = {
							x: e,
							y: k,
							offset: {
					...
					var r = e.dx - p.dx,
						t = e.dy - p.dy;
					d && (n.transform = !0, this._isMobile && (this.leftPage() && this.leftPage().css("-webkit-transform", "translateZ(0)"), this.rightPage() && this.rightPage().css("-webkit-transform", "translateZ(0)")));
					f(this).animate({
						_zoomAnimating: a
					}, {
						duration: b,
		...
		zoomTouchSupport: function () {
			if (this.opts.touchEnabled) {
				if (f.browser.ie8mode || f.browser.ie7) return this.zoomDragSupportForIE();
				var a = this,
					b, c, d;
				a._hammer =
					new Hammer(a.zoomContent[0], a.opts.touch);
				var e = a._hammer;
				...
				e.on("hammer.input", function (g) {
					if (a.zoomContent.hasClass("wowbook-draggable") && (f(g.target).is("img") && "mousedown" == g.srcEvent.type && g.preventDefault(), g.isFinal && a.zoomContent.hasClass("wowbook-dragging"))) {
						...
						var k = a._zoomDataRAF,
							n = k ? k.level : g;
						n < a.zoomMin || n == a.zoomMin && (a._zoomOffset.dx ||
							a._zoomOffset.dy) ? k ? k.callback = function () {
							a.zoomReset()
						} : a.zoomReset() : (a._zoom(g, {
							force: !0,
				...
				e.on("panstart panmove", function (g) {
					a.zoomed && (g.preventDefault(), d = null, c || (c = {
				...
				a.opts.pinchToZoom && (e.get("pinch").set({
						enable: !0
					}),
					e.get("pinch").recognizeWith("pan"));
				this.opts.doubleClickToZoom && (e.get("doubletap").set({
					posThreshold: 50
		...
		zoomDragSupportForIE: function () {
			var a = this,
				...
				d = function (e) {
					e = a.zoomLevel;
					(e < a.zoomMin ||
						e == a.zoomMin && (a._zoomOffset.dx || a._zoomOffset.dy)) && a.zoomReset();
			...
			a.zoomContent.bind("mousedown.wowbook", function (e) {
				if (a.zoomed) return b = {
					...
					pageX: e.pageX,
					pageY: e.pageY
				}, f(document).bind("mousemove.wowbook", c).bind("mouseup.wowbook", d), !1
			})
		},
		detectBestZoomMethod: function (a, b, c) {
			...
			a = f.browser.chrome || f.browser.webkit || f.browser.safari || f.browser.opera || c || !a;
		...
		setupFullscreen: function () {
			if (I) {
				...
				this._fullscreenChangeHandler =
					function () {
						var d = !!P();
						f(a.opts.fullscreenElement).toggleClass("fullscreen wowbook-fullscreen-fix", d);
				...
				this._fullscreenErrorHandler = function () {
					var d;
					a.opts.onFullscreenError && (d = a.opts.onFullscreenError.apply(this, arguments));
					!1 !== d && ("string" == typeof d ? alert(d) : a.opts.onFullscreenErrorMessage && alert(a.opts.onFullscreenErrorMessage))
				};
		...
		positionBookShadow: function () {
			...
			if (b) {
				...
				if (a && c) this.bookShadow.hide();
					...
					c = this.opts.zoomUsingTransform ? this.currentScale * this.zoomLevel : 1;
					var e = this.elem.is(":visible") ? this.pagesContainer.position().left : parseFloat(this.pagesContainer.css("left")) || 0;
		...
		playFlipSound: function () {
			if (this.flipSound) {
				...
				f.isFunction(a) && !1 === a(this) || (this.audio || (this.audio = this.createAudioPlayer()), this.audio && this.audio.play && this.audio.play())
			}
		},
		...
		createAudioPlayer: function (a, b) {
			...
			for (var c = [], d = 0, e = b.length; d < e; d++) c.push('<source src="' + a + b[d] + '">');
		...
		touchSupport: function () {
			...
			f(document).on("touchend.wowbook touchcancel.wowbook", function (b) {
				if (a._touchStarted) {
					!a._touchEnded && f(b.target).hasClass("wowbook-handle") && (b = f(b.target).data("corner"), "r" === b && a.gotoRight(), "l" === b && a.gotoLeft());
					b = a._touchStarted;
		...
		pageEdgeDragStart: function (a) {
			if (!this.zoomed) {
				if (this.animating && !this.curledPage || !f(a.target).hasClass("wowbook-handle")) return !1;
				var b = this,
					c = b.origin.offset();
				...
				f(document).bind("mousemove.wowbook",
					function (e) {
		...
		pageEdgeDragStop: function (a) {
			...
			this._singlePage ? this.pageGrabbed.onLeft ? c > this.pageWidth / 2 ? this.pageGrabbed.pageIndex == this.currentPage ? this.rtl ? this.advance() : this.back() : (c = this.pageGrabbed.pageIndex + (this.rtl ? 1 : -1), this.gotoPage(c)) : this.releasePage(this.pageGrabbed, !0) : c < this.pageWidth + this.pageWidth / 2 ? this.pageGrabbed.pageIndex ==
				this.currentPage ? this.rtl ? this.back() : this.advance() : (c = this.pageGrabbed.pageIndex + (this.rtl ? -1 : 1), this.gotoPage(c)) : this.releasePage(this.pageGrabbed, !0) : this.mouseDownAtLeft && !a ? this.rtl ? this.advance() : this.back() : !this.mouseDownAtLeft && a ? this.rtl ? this.back() : this.advance() : this.releasePage(this.pageGrabbed, !0);
			this._dragging = !1;
		...
		uncurl: function (a, b) {
			if (this.curledPage) {
				...
				if ("number" == typeof a || "string" == typeof a) a =
					this.pages[+a];
		...
		initThumbnails: function () {
			var a = this.opts;
			this.thumbnails = [];
			var b = this.thumbnailsContainer = f("<div class='wowbook-thumbnails'>").append("<div class='wowbook-wrapper'><a class='wowbook-back wowbook-button wowbook-control wowbook-control-back'></a><div class='wowbook-clipper'><ul></ul></div><a class='wowbook-next wowbook-button wowbook-control wowbook-control-next'></a></div>").css("display",
				"none").css("transform", "translateZ(0)").appendTo(f(a.thumbnailsParent));
			...
			this.thumbnailsBackButton = b.find(".wowbook-back.wowbook-button").on("click", function () {
				d._moveThumbnailsList(d.thumbnailsClipper[e]())
			});
			this.thumbnailsNextButton = b.find(".wowbook-next.wowbook-button").on("click", function () {
				d._moveThumbnailsList(-d.thumbnailsClipper[e]())
			});
		...
		scrollBarWidth: function () {
			var a = f("<div style='width:50px;height:60px;overflow-y:auto;display:inline-block;position: absolute;left:-1000px;'></div>").appendTo("body"),
				b = a.width(),
				c = f("<div style='width:100%;height:100px;display:inline-block;'>Hi!<br/>He<br/>llo!</div>").appendTo(a).width();
			a.remove();
			return b - c
		},
		createThumbnails: function () {
			...
			if (this.rtl)
				for (d = this.thumbnailsList.children(), d.eq(0).addClass("wowbook-right").removeClass("wowbook-left"), b = 1, c = d.length; b < c; b += 2) d.eq(b).insertAfter(d.eq(b + 1));
		...
		_setThumbnailsContainerWidth: function () {
			...
			if (this.opts.thumbnailsContainerWidth) a.width(this.opts.thumbnailsContainerWidth);
		...
		thumbnailConfig: function () {
			var a = {},
				b = f('<div class="wowbook-thumbnail" style="display:none;position:absolute;line-height:0px;font-size:0px;">').prependTo(this.thumbnailsContainer),
				c = this.opts.thumbnailHeight || (2 >= b.height() ? 0 : b.height()),
				d = this.opts.thumbnailWidth || b.width(),
				e = d / this.pageWidth ||
				c / this.pageHeight || this.opts.thumbnailScale;
			b.remove();
			...
			f.wowBook.support.transform ? a.cloneCSS.transform = "scale(" + e + ")" : a.cloneCSS.zoom = e;
			this.differentPageSizes && (b = this.opts.pageWidth ? e * this.pageWidth / this.opts.pageWidth : this.opts.pageHeight ? e * this.pageHeight / this.opts.pageHeight : this.opts.thumbnailScale, a.scaleInternalPage =
				f.wowBook.support.transform ? {
					transform: "scale(" + b + ")"
				} : {
					zoom: b
		...
		_setThumbnailsListPosition: function (a, b) {
			...
			b.complete = function () {
				(g.pdfDoc || g.opts.thumbnailsImages || g._customThumbnail) && g.updateVisibleThumbnails()
			};
		...
		updateVisibleThumbnails: function () {
			if (this.thumbnails) {
				...
				var e, g;
				for (a = 0; a < this.thumbnails.length; a++) void 0 == e && d[a] > b && (e = a), void 0 == g && d[a] > c && (g = a);
				e || (e = 0);
				g || (g = this.thumbnails.length - 1);
				this.pdfDoc && (this.pdfCancelRenderThumbnail(0, e), this.pdfCancelRenderThumbnail(g,
		...
		toggleThumbnails: function (a) {
			f(this.thumbnailsContainer).is(":visible") ? this.hideThumbnails(a) : this.showThumbnails(a)
		},
		setPDF: function (a) {
			this.pdf = a;
			this.pdfRenderQueue = [];
			...
			PDFJS.getDocument(a, null, null, this.opts.onPDFLoadProgress).then(function (c) {
				b.pdfDoc = c;
			...
			if (this.pdfPageRendering) this.pdfQueueRenderPage(a, b, c, d, e);
				...
				this.pdfDoc.getPage(a + 1).then(function (k) {
					...
					if (g.opts.pdfUpdateRender && "thumb" != e) {
						...
						n = p.pageWidth * u;
						g.opts.pdfRoundWidth && .5 <= n % 1 && (n = Math.round(n));
						var A = k.getViewport(1);
						n = k.getViewport(n / A.width);
						b ? f(b).addClass("wowbook-pdf-zoom-" + u).css({
							transform: "scale(" + 1 / u + ")",
							"transform-origin": "0 0 0"
						}) : (b = p.find(".wowbook-pdf-zoom-" + u), t = b.length,
							b.length || (b = f("<canvas>").addClass("wowbook-pdf-zoom-" + u), b.css({
								transform: "scale(" + 1 / u + ")",
								"transform-origin": "0 0 0"
							}), r = !0), b = b[0])
					}
					t || (b.height = Math.ceil(n.height), b.width = Math.ceil(n.width));
					u = {
						canvasContext: b.getContext("2d"),
						viewport: n
					};
					n = function () {
						r && !f(b).parent().length && f(b).appendTo(p.find(".wowbook-page-content"));
						c && c.call(g, g.pages[a], b);
						if ("thumb" != e) {
							p.find("canvas").not(b).remove();
							var D = k.getViewport(1 * g.pdfCSS_UNITS * g.opts.pdfScale);
							D = k.getViewport(g.pdfWidth / D.width * g.pdfCSS_UNITS *
								g.opts.pdfScale);
							if (!p.find(".wowbook-pdf-annotations").length) {
								var F = f('<div class="wowbook-pdf-annotations">').appendTo(p.find(".wowbook-page-content"));
								g.pdfAnnotations(k, D, F)
							}
							g.opts.pdfTextSelectable && !p.textLayer && "thumb" != e && g.pdfTextLayer(k, a, D)
						}
		...
		pdfUpdateRender: function (a) {
			if (this.opts.pdfUpdateRender) {
				...
				b && this.pdfRenderPage(b.pageIndex,
					void 0, a);
		...
		pdfTextLayer: function (a, b, c, d) {
			if (!d) {
				...
				d.length || (d = f('<div class="wowbook-pdf-text">').appendTo(e.find(".wowbook-page-content")))
			}
		...
		pdfNavigateTo: function (a) {
			...
			var c = function (d) {
				var e = d instanceof Object ? b.pagesRefMap[d.num + " " + d.gen + " R"] : d + 1;
				e ? b.gotoPage(e - 1) : b.pdfDoc.getPageIndex(d).then(function (g) {
					b.pagesRefMap[d.num + " " + d.gen + " R"] = g + 1;
					c(d)
				})
			};
			("string" == typeof a ?
				this.pdfDoc.getDestination(a) : Promise.resolve(a)).then(function (d) {
		...
		pdfRenderThumbnail: function (a, b, c) {
			...
			if ((c = this.pages[a]) && !c.loading && !b.pdf && !b.rendering) {
				b.rendering = !0;
				var d = b.find("canvas");
				d.length || (d = f("<canvas>").appendTo(b.find(".wowbook-page-content")));
				d.css("transform", "");
				...
				this.pdfRenderPage(a, d[0], function (e, g) {
					d.css("display", "block");
					b.rendering = !1;
					b.pdf = !0;
		...
		createFindControl: function (a,
			b) {
			b || (b = this.opts);
			var c = this;
			f(a).addClass("wowbook-control-find").on("click.wowbook", function (d) {
				if (!f(d.target).closest(".wowbook-findbar").length) return c.toggleFindBar(), !1
			})
		},
		toggleFindBar: function (a) {
			a || (a = f(this._pdfFindBar));
			a.hasClass("wowbook-hidden") ? (a.css("opacity", 0).removeClass("wowbook-hidden"), J(a) || a.toggleClass("wowbook-up"), a.css("opacity", 1), a.find(".wowbook-find-text").focus()) : a.addClass("wowbook-hidden")
		},
		...
		createContainer: function (a) {
			...
			this.containerBook = f("<div class='wowbook-book-container'>").appendTo(a).append(this.elem);
		...
		updateContainer: function () {
			...
			a.toolbarParent == this.containerToolbar && ((b = "top" == a.toolbarPosition) && !this.containerToolbar.is(".wowbook-top") &&
				this.containerToolbar.insertBefore(this.containerBook), !b && this.containerToolbar.is(".wowbook-top") && this.containerToolbar.insertAfter(this.containerBook), this.containerToolbar.toggleClass("wowbook-top", b), b = f(this.toolbars[0]).outerHeight(!0));
		...
		lightbox: function (a) {
			this._lightboxElem = f("<div class='wowbook-lightbox'>").appendTo("body").addClass(this.opts.lightboxClass);
			this._lightboxBookContainer = f("<div class='wowbook-book-container'>").appendTo(this._lightboxElem);
			this._lightboxOverlay = this.opts.lightboxOverlay ? f("<div class='wowbook-lightbox-overlay'>").appendTo("body") : f();
			...
			this.opts.lightboxResponsive &&
				(this.opts.scaleToFit = this._lightboxBookContainer, this.responsive());
			...
			f("<button class='wowbook-close'>\u2715</button>").appendTo(this._lightboxElem).on("click.wowbook", function () {
				b.hideLightbox()
			});
			f(document).on("keydown.wowbook.lightbox", function (c) {
				b.lightboxOn && (f(c.target).filter("input, textarea, select").length || 27 === c.which && b.hideLightbox())
			})
		},
		...
		showLightbox: function () {
			...
			if (this.opts.toolbarParent == this._lightboxElem) {
				...
				this._lightboxBookContainer.css(b,
					a);
		...
		hideLightbox: function () {
			...
			if (this.opts.onHideLightbox) this.opts.onHideLightbox(this,
				this.pages[this.currentPage], this.currentPage)
		},
		centerLightbox: function () {
			var a = f(window).width(),
				b = f(window).height();
			(f.browser.chrome || f.browser.webkit || f.browser.safari || f.browser.opera) && window.innerHeight > b && (b = window.innerHeight);
			...
			this.opts.toolbarParent == this._lightboxElem && (this.opts.responsiveToolbar && this.updateResponsiveToolbar(), a = f(this.toolbars[0]).outerHeight(!0),
				this._lightboxBookContainer.css("height", this._lightboxElem.outerHeight() - a))
		},
		setStyle: function (a) {
			"string" == typeof a && (this._customCSSClass = a);
			f.isPlainObject(a) && (this._customCSSClass || (this._customCSSClass = this.generateCSSClassName()), a = this.generateCSSClass(a, this._customCSSClass), f("body").append("<style>" + a + "</style>"));
			a = this._customCSSClass;
			f(this.toolbars).addClass(a).find(".wowbook-controls").addClass(a).find(".wowbook-share-buttons").addClass(a);
		...
		generateCSSClassName: function () {
			f.wowBook.utils._cssClassCounter = (f.wowBook.utils._cssClassCounter || 0) + 1;
		...
		controllify: function (a) {
			...
			f(a.zoomOut || a.zoomout).on("click.wowbook",
				function () {
					b.zoomOut({});
					return !1
				});
			...
			var d = c.downloadURL || c.downloadurl || c.downloadUrl || (f.isPlainObject(c.pdf) ? c.pdf.url : c.pdf);
			...
			c = "zoomIn zoomOut zoomReset left lastLeft right lastRight next back first last slideShow flipSound thumbnails fullscreen toc currentPage download find home".split(" ");
			for (var e = 0, g = c.length; e < g; e++) d = c[e].toLowerCase(), this._controls[d] = f(this._controls[d]).add(a[c[e]] || a[d]);
			this.setStrings()
		},
		toggleControl: function (a, b) {
			(a = this._controls[a.toLowerCase()]) && f(a).toggleClass("wowbook-disabled", b)
		},
		createNavigationControls: function (a) {
			if (!this._isMobile || !this.opts.responsiveNavControls)
				if (a || (a = this.opts.navControls), "parent" === a && (a = this.elem.parent()), !0 === a && (a = this.containerBook || this._lightboxBookContainer), a) {
					...
					var b = f("<button class='wowbook-nav wowbook-nav-left wowbook-disabled'><i></i></button>").appendTo(a);
					a = f("<button class='wowbook-nav wowbook-nav-right wowbook-disabled'><i></i></button>").appendTo(a);
					this.controllify({
						left: b,
						right: a
					});
		...
		createShareControl: function (a, b) {
			b || (b = this.opts);
			for (var c = f.extend({}, this.shareControlButtons, b.shareButtons), d, e = b.share.split(/\s*,\s*|\s+/), g = f("<div class='wowbook-share-buttons wowbook-hidden'>"), k = 0, n = e.length; k < n; k++)(d = c[e[k]]) && f(d[0]).appendTo(g).addClass("wowbook-control wowbook-share-button").data("params", d[1]);
		...
		toggleShareButtons: function (a) {
			...
			a.hasClass("wowbook-hidden") ? (a.css("opacity", 0).removeClass("wowbook-hidden"), J(a) || a.toggleClass("wowbook-up"), a.css("opacity", 1)) : a.addClass("wowbook-hidden")
		},
			...
			if (a.length) {
				...
				c.on("keypress.wowbook",
					function (e) {
						...
						!e.which || 49 <= e.which && 57 >= e.which || 48 == e.which && f(this).val() || g || e.preventDefault()
					});
		...
		createToolbar: function (a, b) {
			if (a && (b = f(b || this.opts.toolbarParent || this.elem.parent())) && b.length) {
				...
				a = a.trim().split(/\s*,\s*/);
				for (var e = {}, g, k = 0; k < a.length; k += 1) g = this.createToolbarControl(a[k]), e[a[k]] = g, d.append(g);
				this.opts.removeStickyHoverStyle && (c.on("touchstart", ".wowbook-control", function () {
					...
					f(".remove-sticky-hover-style").removeClass("remove-sticky-hover-style");
		...
		createMobileToolbarToggle: function () {
			this.mobileToolbarToggle = f("<a class='wowbook-control wowbook-control-toggle-toolbar'><i></i></a>").prependTo(this.mobileToolbar.find(".wowbook-controls"));
			var a = this;
			this.mobileToolbarToggle.on("click", function () {
				a.toogleMobileToolbar()
			});
			f(window).on("resize.wowbook",
				function () {
		...
		createResponsiveToolbarToggle: function () {
			this.responsiveToolbarToggle = f("<a class='wowbook-control wowbook-control-toggle-toolbar'><i></i></a>").prependTo(this.responsiveToolbar.find(".wowbook-controls"));
			var a = this;
	...
	f.browser.ie7 = f.browser.msie && (7 == f.browser.version || 7 == document.documentMode);
	var w =
		f.browser.msie && 9 > f.browser.version ? 1 : 0,
		K = {
			thin: 2 - w,
			medium: 4 - w,
			thick: 6 - w
		...
		C = window.document,
		M = C.documentElement,
		I = M.requestFullscreen || M.mozRequestFullScreen || M.msRequestFullscreen || M.webkitRequestFullscreen || M.webkitRequestFullScreen,
		O = C.exitFullscreen || C.mozCancelFullScreen || C.msExitFullscreen || C.webkitExitFullscreen || C.webkitCancelFullScreen,
		P = function () {
			return C.fullscreenElement || C.mozFullScreenElement || C.msFullscreenElement || C.webkitFullscreenElement || C.webkitCurrentFullScreenElement
		};
	f.wowBook.utils = {
		translate: function (a, b, c) {
			return f.wowBook.useTranslate3d ? "translate3d(" + a + "px, " + b + "px, " + (c || 0) + "px) " : "translate(" + a + "px, " + b + "px) "
		},
		isMobile: function () {
...
(function (f) {
	function H(B) {
		...
		var I = C;
		void 0 !== w.axis && w.axis === w.HORIZONTAL_AXIS && (I = 0, M = -1 * C);
	...
	if (f.event.fixHooks)
		for (var J = E.length; J;) f.event.fixHooks[E[--J]] =
			f.event.mouseHooks;
...
(function (f) {
	function H(B) {
		...
		for (var w = J.length, K, C = B.charAt(0).toUpperCase() + B.substr(1); w--;)
	...
	if (f.cssHooks) {
		...
		H("boxSizing");
		H("zoom");
		f.wowBook.support.boxSizing && 8 > document.documentMode && (f.wowBook.support.boxSizing = !1);
		E = null;
		f.each(["transform", "transformOrigin"], function (B, w) {
			f.wowBook.support[w] &&
				f.wowBook.support[w] !== w && !f.cssHooks[w] && (f.cssHooks[w] = {
					get: function (K, C, M) {
		...
		f.wowBook.applyAlphaImageLoader = function (B) {
			...
			for (K = B.length; I < K; I++) {
				var O = B[I];
				M.addClass(O);
				if (w = M.css("background-image").match(/^url\("(.*)"\)$/)) C += "." + O + "{background:none; filter : progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + w[1] + "', sizingMethod='scale'); } ",
					M.removeClass(O)
			}
